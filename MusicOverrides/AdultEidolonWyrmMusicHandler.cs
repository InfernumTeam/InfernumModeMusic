...
namespace InfernumModeMusic.MusicOverrides
{
    public class AdultEidolonWyrmMusicHandler : ModSceneEffect
    {
        ...
        public override bool IsSceneEffectActive(Player player) => InfernumModeMusic.Calamity != null && InfernumModeMusic.CanPlayMusic(InfernumModeMusic.Calamity.Find<ModNPC>("PrimordialWyrmHead").Type) && InfernumMusicConfig.Instance.OverrideAdultEidolonWyrmTheme;
